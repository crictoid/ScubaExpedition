...
' Author:			Mark Bulmer 
' Date:				March 28, 2022
' Purpose:			The Scuba Expeditions app determines the location and scuba dives available and calculates the total dive team cost. 
...
Public Class frmScuba
	...
	Private _strDivel As String = "Great Barrier Reef"
